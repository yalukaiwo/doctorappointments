...
class EditCardiologist {
  ...
  getInfo() {
    const info = new GetInfo().cardiologist(this.id);
    return info;
  }
  getInputData() {
    const info = new GetInputInfo().cardiologist();
    return info;
  }
  render() {
    const data = this.getInfo();
    ...
    form.classList = "card__info-wrapper";
    form.id = `editItem${this.id}`;
    form.innerHTML = `<form class="card__short-info">
                <input
                  type="text"
                  id="editNameInput"
                  class="card__name-input"
                  value="${data.name}"
                />
                <select id="editDoctorSelect5" class="card__doctor-input">
              ...
              <div class="card__full-info">
                ...
                <div class="card__element">
                  ...
                  <input
                    type="text"
                    id="editCardioAgeInput5"
                    class="card__edit-input"
                    value="55"
                  />
                </div>
                <div class="card__edit-buttons buttons">
                  <button class="buttons-cancel card__button">Cancel</button>
                  <button class="buttons-submit card__button">Submit</button>
                </div>
              </div>
...
class GetInputInfo {
  ...
  сardiologist() {
    ...
    const duedate = document.getElementById(`editDueDateInput`).value;
    const age = document.getElementById(`editAgeInput`).value;
    // const heartDeseases = document.getElementById();
    // const massIndex = document.getElementById();
  ...
  dentist() {
    ...
    const duedate = document.getElementById(`editDueDateInput`).value;
    const age = document.getElementById(`editAgeInput`).value;
    // const lastVisit = document.getElementById(`edit`).value;
    return [name, importance, goal, description, duedate, age];
  }
}
